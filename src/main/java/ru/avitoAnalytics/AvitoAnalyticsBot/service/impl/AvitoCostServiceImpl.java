...
public class AvitoCostServiceImpl implements AvitoCostService {
    ...
    @Override
    public Optional<AvitoCost> findAvitoCost(String region, String city, String address, String category, String subcategory, String param) {
        return avitoCostJdbcRepository.findAvitoCost(region, city, address, category, subcategory, param)
                .or(() -> avitoCostJdbcRepository.findAvitoCost("другой регион", city, address, category, subcategory, param));
    }
}
